// ========================================================
// JARVIS CHANGE HEADER -- HOME SCREEN WORLD LIST (V1.3 STORAGE)
// File: src/screens/HomeScreen.tsx
//
// Fixes:
// - Uses listWorldSummaries() from IndexedDB storage.
// - Routes to Generate/Create/Sim consistently.
// - Delete world support.
...
export function HomeScreen() {
  ...
  const goGenerate = () => nav("/generate");
  const goCreate = (id: string) => nav(`/create/${id}`);
  const goSim = (id: string) => nav(`/sim/${id}`);
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
        <div>
          ...
          <div style={{ opacity: 0.75, marginTop: 4 }}>
            Select a world, or generate a new one.
          </div>
        </div>
        ...
        {loading ? (
          ...
          >
            ...
            <div style={{ marginTop: 8, opacity: 0.8 }}>
              Create your first world in Generate Mode.
            </div>
            <button
              onClick={goGenerate}
