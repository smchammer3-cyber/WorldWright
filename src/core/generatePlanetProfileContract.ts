...
export const PLANET_PROFILE_CONTRACTS: readonly PlanetProfileContract[] = [
  {
    ...
    requiredLayers: [
      ...
      'PLATE_SHELL',
      'BOUNDARY_FEATURES',
      'CONTINENTAL_MORPHOLOGY',
      'CRUST_MATERIAL',
      'TERRAIN_RESPONSE',
      'WATER_SURFACE_STATE',
      'CLIMATE_HYDROLOGY_BIOME',
      'FINAL_RENDER',
      'EXPORT',
    ],
    ...
    notes: [
      'Strict calibration profile for neutral Earthlike worlds.',
      'May use sliders for dry/flooded/hot/cold/extreme variants, but hard authority rules do not relax.',
    ],
  },
  {
    id: 'ROCKY_ALIEN',
    ...
    forbiddenLayers: ['CLOUD_GAS_SURFACE'],
    allowedSurfaceMaterials: ['rock', 'soil', 'sediment', 'ice', 'salt', 'sulfur', 'carbon', 'water'],
    notes: [
      'Uses solid surface support, but allows wider chemistry, climate, heat, and gravity bands than Earthlike.',
      'Can use plate, stagnant-lid, hybrid, or hotspot-dominant geology when those stacks are registered.',
    ],
  },
  {
    ...
    notes: [
      'Physically safe version of the hot-gas-center idea: a solid or ice shell sits above volatile pressure.',
      'Volatile pressure may deform/crack the shell and create domes, vents, geysers, collapse basins, and chaos terrain.',
      'Volatile pressure cannot replace the support shell as terrain authority.',
    ],
  },
  {
    ...
    notes: [
      'Rock/metal interior plus deep ocean plus ice shell, possibly tidally heated.',
      'Normal continents, shelves, and rocky crust provinces are illegal unless this is explicitly configured as a frozen rocky planet.',
    ],
  },
  {
    ...
    notes: [
      'Small rounded body profile: low gravity, thin atmosphere risk, sharp relief possible.',
      'May have localized internal/tidal heat, cryovolcanism, ancient surface, or cratered terrain in later layers.',
    ],
  },
  {
    ...
    allowedSurfaceMaterials: ['rock', 'soil', 'sediment', 'ice', 'water'],
    notes: [
      'Higher gravity rocky planet: lower relative relief, stronger atmosphere retention, broader smoother terrain expectations.',
    ],
  },
  {
    id: 'CLOUD_GAS_WORLD',
    label: 'Cloud/gas world',
    stackFamily: 'CLOUD_GAS',
    surfaceSupportMode: 'CLOUD_GAS_NO_SURFACE',
    validForEarthlike: false,
    validForAlien: true,
    validForFantasy: true,
    requiredLayers: ['PLANET_SIZE_GRAVITY', 'STELLAR_ENERGY', 'ATMOSPHERE_RETENTION', 'CLOUD_GAS_SURFACE', 'FINAL_RENDER', 'EXPORT'],
    forbiddenLayers: ['CONTINENTAL_MORPHOLOGY', 'CRUST_MATERIAL', 'LANDMASS_TERRAIN', 'SHELVES', 'NORMAL_RIVER_HYDROLOGY'],
    allowedSurfaceMaterials: ['clouds', 'aerosols', 'storm bands'],
    notes: [
      'No true solid surface for landmasses.',
      'Land requires an explicit artificial/fantasy shell or moon stack, not the gas envelope itself.',
    ],
  },
  {
    ...
    notes: [
      'Permits non-natural support logic only when explicitly selected.',
      'Still must declare terrain authority and final color authority.',
    ],
  },
];
