...
export default function SimModeApp() {
    ...
    const rightPanel = (_jsxs("div", { style: { padding: 14, color: "rgba(255,255,255,0.88)" }, children: [_jsx("h3", { style: { margin: "6px 0 10px 0" }, children: "Sim" }), _jsxs("div", { style: { display: "flex", gap: 10, marginBottom: 12 }, children: [_jsx("button", { onClick: () => worldSession.simulateTick(), disabled: !world || loading, style: {
                            padding: "10px 12px",
                            borderRadius: 10,
                        ...
                        }, children: "Back to Create" })] }), _jsx("div", { style: { fontSize: 12, opacity: 0.8, lineHeight: 1.4 }, children: "Sim overlays (Culture/Trade/Routes) will be added after stability." })] }));
    if (loading) {
    ...
    return (_jsx(AppShell, { mode: "sim", onGoHome: () => navigate("/"), worldName: world?.metadata?.name || "Sim", isDirty: worldSession.isDirty(), onModeToggle: () => navigate(`/create/${worldId}`), rightPanel: rightPanel, toolGroups: [
        ...
        ], children: _jsx("div", { style: { width: '100%', height: '100%', position: 'relative' }, children: world ? (_jsx(Globe3D, { world: world, className: "" })) : (_jsx("div", { style: { padding: 20, color: 'rgba(255,255,255,0.85)' }, children: "No world loaded." })) }) }));
}
