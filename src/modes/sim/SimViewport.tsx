...
export default function SimViewport({ world }: Props) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "auto" }}>
      <div style={{ padding: 12, fontWeight: 900 }}>Sim View</div>
      <div style={{ padding: 12 }}>
        ...
        <div style={{ fontSize: 11, opacity: 0.65, marginTop: 8 }}>
          Viewer preview. Sim overlays will be layered here later (cultures/settlements/trade).
        </div>
      </div>
    </div>
  );
